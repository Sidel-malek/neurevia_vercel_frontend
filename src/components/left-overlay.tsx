...
export default function LeftOverlay({ isAnimated, setIsAnimated }: LeftOverlayProps) {
  return (
    <div className="text-center text-white p-8 max-w-md relative z-10">
      <div className="space-y-6">
        ...
        <p className="text-lg mb-8 text-white/90 relative">
          Join us in revolutionizing brain health through AI and precision medicine.
        </p>
        <Button
